function PlayerControls ( camera, player, domElement ) {
	...
	this.center = new Vector3( player.position.x, player.position.y, player.position.z );
	...
	var lastPosition = new Vector3( player.position.x, player.position.y, player.position.z );
