...
const submit = document.querySelector(".game #LoginScreen #submit");

submit.addEventListener("click", function(event) {
    event.preventDefault();
    const emailInput = document.querySelector(".game #LoginScreen .EmailInput").value;
const passwordInput = document.querySelector(".game #LoginScreen .PasswordInput").value;
